            ...
            event.waitUntil(
              caches.open('cache').then(function(cache) {
                ...
                return cache.addAll([
                  ...
                  '/', // do not remove this
                  '/login.html', //default
                  '/login.html?homescreen=1', //default
                  '/?homescreen=1', //default
                  'css-scrap/app.css', // configure as by your site ; just an example
                  'js-scrap/app.js', // configure as by your site ; just an example
                  'images-scrapicons/icon-72x72.png', // add more icons path below as in this line. Check out the icons path in the icons folder.
